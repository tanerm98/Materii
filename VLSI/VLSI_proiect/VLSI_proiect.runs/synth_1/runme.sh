...
HD_PWD='C:/Users/Taner/Desktop/VLSI/VLSI_proiect/VLSI_proiect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simulare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simulare.tcl
