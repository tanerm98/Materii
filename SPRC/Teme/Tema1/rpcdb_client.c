...
//		clnt_perror (clnt, "call failed");
//	}
//	result_4 = update_1(&update_1_arg, clnt);
//	if (result_4 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_5 = del_1(&del_1_arg, clnt);
//	if (result_5 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_6 = read_1(&read_1_arg, clnt);
//	if (result_6 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_7 = get_stat_1(&get_stat_1_arg, clnt);
//	if (result_7 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_8 = get_stat_all_1(&get_stat_all_1_arg, clnt);
//	if (result_8 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_9 = load_1((void*)&load_1_arg, clnt);
//	if (result_9 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//	result_10 = store_1((void*)&store_1_arg, clnt);
//	if (result_10 == (package *) NULL) {
//		clnt_perror (clnt, "call failed");
//	}
//#ifndef	DEBUG
//	clnt_destroy (clnt);
...
void login(char *command) {
	...
	login_arg.message = user;
    result = login_1(&login_arg, clnt);
	...
	if (&(result -> token) == NULL) {
		printf("[ERROR] Could not get login token!\n");
		exit(1);
	}
